...
import { getSiteContent, getLocationImage } from '@/lib/local-store';
...
export default function LocationPage() {
  ...
  useEffect(() => {
    ...
    getLocationImage().then(setMapImage);
  }, []);
    ...
    <div className="max-w-3xl">
      ...
      <div className="rounded-xl overflow-hidden mb-6" style={{ minHeight: '280px' }}>
        {mapImage ? (
          ...
          <div className="bg-gray-100 flex items-center justify-center rounded-xl" style={{ height: '280px' }}>
            <div className="text-center text-gray-400">
              ...
              <p className="text-xs mt-1">관리자 페이지 → 총동아리연합회 → 오시는 길에서 업로드</p>
            </div>
          </div>
        )}
      </div>
