...
const DEFAULT_URL = 'https://app.notion.com/p/3b9aa25bb02580fb83b9f4dd0490c772';

export default function ReservationPage() {
  const [notionUrl, setNotionUrl] = useState(DEFAULT_URL);

  useEffect(() => {
    getSiteContent().then(c => {
      if (c.notionReservationUrl) setNotionUrl(c.notionReservationUrl);
    });
  }, []);
