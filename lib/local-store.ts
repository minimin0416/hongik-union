...
export type ClubData = { id: number; name: string; category: string; room: string; president: string; recruitPeriod: string; meetingSchedule: string; intro: string; desc: string; activities: string[]; targets: string[]; website?: string; logoUrl?: string; imageUrl?: string };
